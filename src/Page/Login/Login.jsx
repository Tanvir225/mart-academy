        ...
        <section className="my-10">
            <div className="flex h-full w-full overflow-hidden rounded-xl shadow-md max-w-5xl mx-auto">
                ...
                <div className="relative hidden items-center justify-center bg-teal-300 md:flex md:w-[50%]">
                    ...
                    <div className="absolute bottom-[18%] left-[20%]  h-20 w-20 rounded-full bg-gradient-to-br from-white via-blue-300 to-teal-400"></div>
                ...
                <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%] dark:bg-zinc-900">
                    ...
                    {/* sign with google */}
                    <button className="group mx-auto flex h-[50px] w-fit items-center overflow-hidden rounded-full shadow-md outline-none ring-1 ring-teal-400">
