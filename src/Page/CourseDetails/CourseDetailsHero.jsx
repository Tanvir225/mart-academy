...
const CourseDetailsHero = () => {
    return (
        <div >
            <div className="lg:h-40 space-y-5 text-center p-5">
                <h1 className="text-xl lg:text-3xl font-semibold leading-10">Get Started with Computers: A Beginner's <span className="bg-teal-200 p-1 px-4 rounded-xl text-black">Guide</span> </h1>
                <p className="lg:w-3/6 mx-auto border-b-2 pb-5 border-teal-200 animate-pulse"><span className="">Lorem ipsum dolor sit</span> amet consectetur, adipisicing elit. Blanditiis, aperiam! Quaerat iusto aspernatur ad provident non, cumque consequatur nesciunt amet!</p>
            </div>
