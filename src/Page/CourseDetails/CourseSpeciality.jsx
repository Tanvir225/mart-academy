        ...
        <section className=" my-10 lg:my-16 bg-no-repeat object-contain border-dotted border-b-2 pb-5 " >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-7 ">
                <section className="space-y-3 p-5 border-2 border-teal-200 rounded-lg my-5 w-full">
                    ...
                    <h2 className="text-lg font-semibold" data-aos="zoom-out" data-aos-duration="400">
                        Live Class
                    </h2>
                    <p className="text-sm">Interactive sessions covering all modules.</p>
                </section>
                <section className="space-y-3 p-5 border-2 border-teal-200 rounded-lg my-5 w-full">
                    <HiOutlineLightBulb deal size={40}  data-aos-duration="1000" color="yellow"></HiOutlineLightBulb  >
                    <h2 className="text-lg font-semibold" data-aos="fade-right" data-aos-duration="1000">
                        {courseDetails?.summary?.projects}  Projects and Assignments
                    </h2>
                ...
                <section className="space-y-3 p-5 border-2 border-teal-200 rounded-lg my-5 w-full">
                    ...
                    <h2 className="text-lg font-semibold" data-aos="fade-left" data-aos-duration="400">
                        {courseDetails?.summary?.modules}  Modules
                    </h2>
                ...
                <section className="space-y-3 p-5 border-2 border-teal-200 rounded-lg my-5 w-full">
                    ...
                    <h2 className="text-lg font-semibold" data-aos="fade-up" data-aos-duration="400">
                        Recorded Class
                    </h2>
                ...
                <section className="space-y-3 p-5 border-2 border-teal-200 rounded-lg my-5 w-full">
                    ...
                    <h2 className="text-lg font-semibold" data-aos="fade-up" data-aos-duration="400">
                        Join Contest Get <span className="bg-teal-200 text-black p-1 rounded-xl">Money</span>
                        </h2>
