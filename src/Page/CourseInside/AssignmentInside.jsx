                    ...
                    <div className=" w-full">
                        ...
                        <div className={`grid overflow-hidden text-slate-600 transition-all duration-300 ease-in-out ${isOpen === idx ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                            <div className="overflow-hidden ">
                                <p className="p-2 text-[12px] md:text-base text-white">Believe you can and you're halfway there.</p>
                                <Link to={data.description} className=" underline block p-2 text-[12px] md:text-base text-white">{data.description}</Link>
                                <p className="px-5 text-[12px] md:text-base text-teal-200 text-right">Marks: {data.marks}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
const dataArr = [
    {
        title: 'Assignment 1 - Compueter Basic',
        description: 'https://meet.google.com/gso-nryd-awm',
        marks : 30
    },
    {
        title: 'Assignment 2 - Compueter Basic',
        description: 'https://meet.google.com/gso-nryd-awm',
        marks : 30,
    },
    {
        title: 'Assignment 3 - Compueter Basic',
        description: 'https://meet.google.com/gso-nryd-awm',
        marks : 30,
    },
