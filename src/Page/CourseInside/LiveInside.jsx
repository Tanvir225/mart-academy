                    ...
                    <div className=" w-full">
                        ...
                        <div className={`grid overflow-hidden text-slate-600 transition-all duration-300 ease-in-out ${isOpen === idx ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                            <div className="overflow-hidden m-3">
                                <p className=" text-[12px] md:text-sm text-white">Believe you can and you're halfway there.</p>
                                <Link to={data.description} className=" underline block py-2 text-sm text-white">{data.description}</Link>
                            </div>
                        </div>
                    </div>
                </div>
